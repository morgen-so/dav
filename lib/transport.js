...
import XMLHttpRequestWrapper from './XMLHttpRequestWrapper';
...
let getAccessToken = co.wrap(function* (credentials, options) {
  ...
  credentials.refreshToken =
    'refresh_token' in response ? response.refresh_token : null;
  credentials.expiration =
    'expires_in' in response ? now + response.expires_in : null;
